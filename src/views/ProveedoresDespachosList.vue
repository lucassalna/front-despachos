<template>
  <div class="p-6">
    ...
    <h1 class="text-2xl font-bold mb-4">Despachos de Proveedores</h1>
    ...
    <ul v-if="despachos.length" class="space-y-4">
      ...
      >
        ...
        <p><strong>Proveedor:</strong> {{ d.supplier_name }}</p>
...
onMounted(async () => {
  try {
    const res = await api.get('proveedores-despachos/list/')
